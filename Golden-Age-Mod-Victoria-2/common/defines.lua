...
country = {
	...
	COLONIAL_RANK = 14, -- Minimum rank a nation must have to send colonists
	...
	COLONIZATION_MONTHS_TO_COLONIZE = 9,
	...
	COLONIZATION_COLONY_STATE_DISTANCE = 430,
...
military = {
	...
	AI_SUPPORT_PROPORTION = 0.15, -- fraction of brigades that should be artillery and other support units
