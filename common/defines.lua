...
country = {
	...
	COLONIAL_RANK = 8, -- Minimum rank a nation must have to send colonists
	...
	CREATED_CB_VALID_TIME = 9,  -- how many months 
	...
	COLONIZATION_MONTHS_TO_COLONIZE = 60,
	COLONIZATION_DAYS_BETWEEN_INVESTMENT = 110,
	COLONIZATION_DAYS_FOR_INITIAL0INVESTMENT = 300,
	...
	COLONIZATION_COLONY_STATE_DISTANCE = 450,
...
military = {
	...
	NAVAL_LOW_SUPPLY_DAMAGE_SUPPLY_STATUS = 0.30, -- how little supply is acceptable before getting damage to STR
...
ai =
{
	COLONY_WEIGHT = 3.0, -- ai weight for colonising
	...
	AGGRESSION_BASE = 4, -- general AI aggression
	AGGRESSION_UNCIV_BONUS = 7, -- additional AI civ aggression against uncivs
	FLEET_SIZE = 15, -- AI will attempt to keep fleets of roughly this size (fewer fleets generally results in more competent naval AI)
